...
public class OracleSQLGenerator extends AbstractSQLGenerator {
    ...
    static {
        ...
        TYPE_MAPPING.put(long.class, "NUMBER(19)");
        TYPE_MAPPING.put(Double.class, "NUMBER(19,4)");
        TYPE_MAPPING.put(double.class, "NUMBER(19,4)");
        TYPE_MAPPING.put(Float.class, "NUMBER(19,4)");
        TYPE_MAPPING.put(float.class, "NUMBER(19,4)");
        TYPE_MAPPING.put(Boolean.class, "NUMBER(1)");
        TYPE_MAPPING.put(boolean.class, "NUMBER(1)");
        TYPE_MAPPING.put(Date.class, "DATE");
        TYPE_MAPPING.put(Time.class, "TIMESTAMP");
        TYPE_MAPPING.put(Timestamp.class, "TIMESTAMP");
        TYPE_MAPPING.put(BigDecimal.class, "NUMBER(19,4)");
    }
    ...
    public String mapJavaTypeToSQLType(Class<?> javaType) {
        ...
        return sqlType != null ? sqlType : "VARCHAR2(255)";
    }
